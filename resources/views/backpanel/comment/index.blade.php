...
<script>
    $(document).ready(function() {
        $('#comments').DataTable({
            ...
            "order": [[1, 'asc']],
            deferRender: true,
            ajax: "{{ route('admin.comment.ajax-comments','1') }}",
            columns: [
                {
                    data: 'id',
                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        ...
                        let approve = "{{route('admin.comment.is_approve',[':id','0'])}}";
                        ...
                        return `<div class="dropdown">
                            ...
                            <ul class="dropdown-menu" style="margin: 0px;">
                                <li><a class="dropdown-item" href="${approve}"><i class="bx bx-reset"></i> Undo Approval</a></li>
