                        ...
                        <div class="col-md-4">
                            ...
                            <div class="d-flex justify-content-between align-content-center my-2 border p-2">
                                <div class="form-group me-1">
                                    ...
                                    <input type="date" readonly class="form-control form-control-sm" value="{{\Carbon\Carbon::parse($poll->starts_at)->format('Y-m-d')}}" />
                                </div>
                                <div class="form-group">
                                    <label class="form-label">Survey Organized By :</label>
                                    <input type="text" readonly class="form-control form-control-sm" value="{{$poll->organized_by}}" />
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            ...
                            <div class=" my-2 border p-2">
                                <textarea readonly class="form-control form-control-sm" rows="2">{{$poll->question}}</textarea>
                            </div>
                        </div>
                        <div class="col-md-5">
                            ...
                            <div class="row row-cols-md-2 g-1 justify-content-between align-content-center my-2 border p-1">
                                ...
                                <div class="col">
                                    <div class="input-group input-group-sm"> <span class="input-group-text rounded-0" id="inputGroup-sizing-sm">{{$key+1}}</span>
