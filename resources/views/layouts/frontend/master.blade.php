...
<body onload="startTime()">
    ...
    <div class="container-fluid d-md-none my-1 d-block mobile-news-alert">
        <div class="row align-items-center">
            ...
            <div class="col-8 px-1 bg-dark-pure d-flex align-items-center">
                <marquee behavior="scroll" direction="left" class="py-2" onmouseover="this.stop();"
                    ...
                    <div class="menu_social">
                        <div class="connectus">
                            ...
                            <a rel="noopener" href="javascript:void(0)" target="_blank">
                                <img data-src="{{asset('front-assets/img/sidebar-icons/social-facebook.svg')}}" alt="facebook" class=" lazyloaded" src="{{asset('front-assets/img/sidebar-icons/social-facebook.svg')}}">
                            </a>
                            <a rel="noopener" href="javascript:void(0)" target="_blank">
                                <img data-src="{{asset('front-assets/img/sidebar-icons/social-twitter.svg')}}" alt="twitter" class=" lazyloaded" src="{{asset('front-assets/img/sidebar-icons/social-twitter.svg')}}">
                            </a>
                            <a rel="noopener" href="javascript:void(0)" target="_blank">
                                <img data-src="{{asset('front-assets/img/sidebar-icons/social-youtube.svg')}}" alt="youtube" class=" lazyloaded" src="{{asset('front-assets/img/sidebar-icons/social-youtube.svg')}}">
                            </a>
                        </div>
                        <p>APPS</p>
                        <a rel="noopener" href="javascript:void(0)" target="_blank">
                            <img data-src="{{asset('front-assets/img/sidebar-icons/menu_android.svg')}}" alt="Andrioid APP" class=" lazyloaded" src="{{asset('front-assets/img/sidebar-icons/menu_android.svg')}}">
                        </a>
                        <a rel="noopener" href="javascript:void(0)" target="_blank">
                            <img data-src="{{asset('front-assets/img/sidebar-icons/menu_ios.svg')}}" alt="IOS APP" class=" lazyloaded" src="{{asset('front-assets/img/sidebar-icons/menu_ios.svg')}}">
                        </a>
                    </div>
                </div>
                <div class="user_menus">
                    <ul class="list-group">
                        ...
                        <li class="position-relative">
                            ...
                            <a class="sidenav-dropbtn" data-toggle="collapse" href="#collapseExample" role="button" aria-expanded="false" aria-controls="collapseExample">
                        ...
                        <li class="position-relative">
                            ...
                            <a class="sidenav-dropbtn" data-toggle="collapse" href="#collapseExample2" role="button" aria-expanded="false" aria-controls="collapseExample">
                                <i class="fa fa-plus"></i></span>
                            </a>
                        ...
                        <li class="position-relative">
                            ...
                            <a class="sidenav-dropbtn" data-toggle="collapse" href="#collapseExample3" role="button" aria-expanded="false" aria-controls="collapseExample">
                                <i class="fa fa-plus"></i></span>
                            </a>
                        ...
                        <li class="position-relative">
                            ...
                            <a class="sidenav-dropbtn" data-toggle="collapse" href="#collapseExample4" role="button" aria-expanded="false" aria-controls="collapseExample">
                                <i class="fa fa-plus"></i></span>
                            </a>
                        ...
                        <li class="position-relative">
                            ...
                            <a class="sidenav-dropbtn" data-toggle="collapse" href="#collapseExample5" role="button" aria-expanded="false" aria-controls="collapseExample">
                                <i class="fa fa-plus"></i></span>
                            </a>
                        ...
                        <li class="position-relative">
                            ...
                            <a class="sidenav-dropbtn" data-toggle="collapse" href="#collapseExample6" role="button" aria-expanded="false" aria-controls="collapseExample">
                                <i class="fa fa-plus"></i></span>
                            </a>
    ...
    <div class="search_container" style="left: -360px;">
        <div class="search_box">
            <form action="/Search">
                <img src="https://english.cdn.zeenews.com/static/public/menusearch.svg" alt="search icon" class="search_icon1 ls-is-cached lazyloaded">
                <input type="text" placeholder="Search here" name="q" minlength="3" class="search_input" required="true">
                <button class="search_submit"><img src="https://english.cdn.zeenews.com/static/public/search_arrow.svg" class=" ls-is-cached lazyloaded" alt="search icon" width="12"></button>
            </form>
        </div>
    </div>
