...
<main class="container-fluid mx-auto mt-1 position-relative">
    <div class="row">
        <div class="col-md-9 col-12 px-0 pr-md-1">
                    ...
                    <div class="col-12">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb m-0 py-0" style="background-color:transparent;font-size:17px">
                                ...
                                <li class="breadcrumb-item"><a class="text-white" href="{{route('tag-news')}}">Tag</a></li>
                                <li class="breadcrumb-item active" aria-current="page"><span>{{$currentTag->name}}</span></li>
                            </ol>
                        </nav>
                    </div>
                    <div class="col-12 mt-3">
                        <h1 class="text-white px-2">{{$currentTag->name}}</h1>
            ...
            {!!AdvertHTML('tag-breadcrumb-bottom-header-800x100')!!}
            ...
            <section class="container-fluid mx-auto mt-3 mb-2 mb-md-0 px-0 text-center">
                {!!AdvertHTML('tag-pagination-bottom-800x100')!!}
            </section>
            <!-- Ad Banner  -->
        </div>
        <aside class="col-md-3 col-12 px-1 my-md-0">
            <div class="sticky-top"  style="z-index:1">
                <div class="ad-box mb-2">
                    {!!AdvertHTML('tag-sidebar-350x300')!!}
                </div>
