                ...
                <div class="row row-cols-2 mx-0 justify-content-between align-items-center">
                    ...
                    <div class="col px-1">
                        <div class="d-flex justify-content-end align-items-center">
                            <a href="javascript:void(0)" style="font-size: 3.5rem" class="mr-2 mr-md-3"><i class="fab fa-whatsapp-square"></i></a>
                            <a href="javascript:void(0)" style="font-size: 3.5rem" class="mr-2 mr-md-3"><i class="fab fa-facebook-square"></i></a>
                            <a href="javascript:void(0)" style="font-size: 3.5rem" class="mr-2 mr-md-3"><i class="fab fa-twitter-square"></i></a>
                        </div>
                    </div>
                </div>
            </div>
